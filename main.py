...
class MyWidget(QMainWindow):
    ...
    def edit_coffee(self):
        ...
        self.edit_coffee_window.name.setText(name)
        self.edit_coffee_window.description.setPlainText(description)
...
class AddEditCoffeeWindow(QMainWindow):
    ...
    def add(self):
        try:
            ...
            if self.edit_id == -1:
                self.cur.execute("INSERT INTO Coffee(name, roasting_id, type_id, description, price, weight) VALUES(?, ?, ?, ?, ?, ?)",
